...
local function showOrHideNodes()
    -- Deactivate all
    Call("ActivateNode", "all", 0)
    Call("ActivateNode", "sluitsein", showSluitsein)
    Call("ActivateNode", "wagon", 1)
    Call("ActivateNode", "wagon_a", 1) -- TODO remove
    Call("ActivateNode", "wagon_b", 1) -- TODO remove
    Call("ActivateNode", "bo02", 1)
    Call("ActivateNode", "bo02wh01", 1)
    Call("ActivateNode", "bo02wh02", 1)
    Call("ActivateNode", "softshadow", 1)
