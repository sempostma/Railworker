...
namespace Railworker.Pages
{
    ...
    /// </summary>
    public partial class RoutesAndScenariosWindow : Page
    {
        ...
        private void EditScenarioButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ((MainWindow)App.MainWindow).OpenTab(new MainWindow.MainWindowViewModel.Tab
            {
                FrameContent = new RollingStockReplacement(scenario),
                Header = Railworker.Language.Resources.rolling_stock_replacement
            });
        }
    }
}
