...
namespace RWLib.Packaging
{
    public class FileItem : MatrixTransformable
    {
        ...
        public static Dictionary<string, List<FileItem>> FromJsonDictionary(string jsonString)
        {
            var options = new JsonSerializerOptions
            {
                ReadCommentHandling = JsonCommentHandling.Skip,
            ...
            return JsonSerializer.Deserialize<Dictionary<string, List<FileItem>>>(jsonString, options)!;
        }
    }
